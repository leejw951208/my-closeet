---
name: plan-pm
description: PM 실행 정의 단계 오케스트레이션. setup-metrics, write-prd, write-stories, plan-okrs를 순차 실행하고 docs/plan/pm/ 경로에 산출물을 저장한다. 사용 예. /plan-pm
---
...
`$ARGUMENTS` 가 있으면 컨텍스트로 사용한다. 비어 있으면 다음 우선순위로 입력을 끌어온다.
